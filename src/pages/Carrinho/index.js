...
function Carrinho() {
  ...
  const {saldo = 0} = useContext(UsuarioContext)
   const { tiposPagamento, formaPagamento, mudarFormaDePagamento} = usePagamentoContext(PagamentoContext)
  ...
  return (
    <Container>
      ...
      <PagamentoContainer>
        ...
        <Select value={formaPagamento.id} onChange={(evento) => mudarFormaDePagamento(evento.target.value) }> 
